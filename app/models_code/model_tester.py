...
try:
    ...
    for i, test_file in enumerate(test_files, 1):
        ...
        try:
            ...
            print(f"💾 Results with predictions saved to: {output_file}")
    ...
    if individual_results:
        ...
        print(f"{'='*50}")
        print("No ground truth labels found in any files.")
        print("Generated predictions for all CSV files.")
    
    print(f"\n💾 All results with predictions saved to: {OUTPUT_FOLDER}")
