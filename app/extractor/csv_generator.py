...
#             # Add span text fields - this is what was actually matched from PDF
#             features['span_text_a'] = line_a.get('span_text', '').strip()
#             features['span_text_b'] = line_b.get('span_text', '').strip()
